...
<div class="main-content">
    ...
    <!-- Header da SeÃ§Ã£o com BotÃ£o de Novo -->
    ...
    <div class="table-section">
        <div class="table-controls">
            <input type="text" id="filtro-rastreio-cnpj" placeholder="ðŸ” Pesquisar por CÃ³digo de Rastreio ou CNPJ..." class="search-input">
        </div>
        ...
        <form id="form-recebimento" action="https://kpi.stbextrema.com.br/BackEnd/Recebimento/Recebimento.php" method="POST">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="cod_rastreio" name="cod_rastreio" required placeholder="Digite o cÃ³digo de rastreio">
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="setor" id="setor">
                        ...
                        <option value="manutencao_externa">ManutenÃ§Ã£o Externa</option>
                        <option value="devolucao">DevoluÃ§Ã£o</option>
                        <option value="devolucao_externa">DevoluÃ§Ã£o Externa</option>
                        <option value="analise">AnÃ¡lise</option>
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="razao_social" name="razao_social" placeholder="RazÃ£o social do cliente">
                </div>
            </div>

            <!-- Bloco: Datas e DocumentaÃ§Ã£o -->
            <div class="form-section">
                <h3 class="section-title">
                    <i class="fas fa-calendar-alt"></i>
                    Datas e DocumentaÃ§Ã£o
                </h3>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="nota_fiscal" name="nota_fiscal" placeholder="NÃºmero da nota fiscal">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="quantidade" name="quantidade" required placeholder="Quantidade de peÃ§as">
                    </div>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <select name="operacao_origem" id="operacao_origem">
                        ...
                        <option value="aguardando_nf">Aguardando EmissÃ£o de nota fiscal</option>
                        <option value="envio_analise">Enviado para anÃ¡lise</option>
                    </select>
                </div>
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    <label for="obs">ObservaÃ§Ãµes Gerais</label>
                    <textarea id="obs" name="obs" rows="4" placeholder="Digite observaÃ§Ãµes relevantes"></textarea>
                </div>
            </div>
...
// ==========================================
// FUNÃ‡Ã•ES ORIGINAIS (PRESERVADAS)
// ==========================================
...
function closeSuccessModal() {
    ...
    closePanel(); // Fechar painel apÃ³s sucesso
}
